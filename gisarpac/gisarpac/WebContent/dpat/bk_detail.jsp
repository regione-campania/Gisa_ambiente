...
<table class="trails" cellspacing="0">
		<tr>
			<td width="100%"><a href="Oia.do">Modellatore Organizzazione ASL</a> &gt <a href="Dpat.do?&idAsl=<%=dpat.getIdAsl()%>&idPadre=<%=idPadre%>&anno=<%=anno%>">DPAT</a> &gt <a href="DpatSDC.do?command=AddModify&idAsl=<%=dpat.getIdAsl()%>&edit=view">Strumento di calcolo</a> &gt Carichi di lavoro</td>	
		</tr>
	</table>
<head>
