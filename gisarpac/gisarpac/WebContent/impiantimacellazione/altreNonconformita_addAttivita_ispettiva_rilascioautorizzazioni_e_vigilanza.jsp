...
<input type="submit" value="<dhv:label name="global.button.cancel">Cancel</dhv:label>" onClick="javascript:this.form.action='ImpiantiMacellazione.do?command=ViewNonConformita'">
<br>
<dhv:formMessage />
...
<dhv:include name="ticket.location" none="true">
  ...
  <tr>
    <td valign="top" class="formLabel">
      <dhv:label name="nonconformita.azioni">Non conformità Rilevate</dhv:label>
    </td>
    <td>
      <table border="0" cellspacing="0" cellpadding="0" class="empty">
        <tr>
