...
function ritornaAllegato (){
	window.opener.divAllegato.innerHTML = "<a href='GestioneAllegatiFascicoliIspettivi.do?command=DownloadPDF&codDocumento=<%=codDocumento%>'><%=titolo%></a><br/><br/>";
	window.opener.codAllegato.value = "<%=codDocumento%>";
	window.close();
}
</script>
