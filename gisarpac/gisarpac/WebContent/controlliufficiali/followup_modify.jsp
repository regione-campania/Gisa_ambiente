...
function checkForm(form) {
  ...
  if(form.nonConformitaGraviValutazione.value == "" || document.getElementById('nonConformitaGraviValutazione').value == 'INSERIRE LA VALUTAZIONE DEL RISCHIO DELLE NON CONFORMITA\' RISCONTRATE'){// se non ho slezionato niente 
