...
<dhv:container name="farmacosorveglianza" selected="audit" object="OrgDetails" param='<%= "orgId=" + OrgDetails.getOrgId() %>'>
  ...
  <input type="button" value="<dhv:label name="global.button.cancel">Cancel</dhv:label>" onClick="window.location.href='CheckListFarmacosorveglianza.do?command=View&id=<%=Audit.getId()%>';this.form.dosubmit.value='false';" />
