...
<input type="submit" value="<dhv:label name="global.button.cancel">Cancel</dhv:label>" onClick="javascript:this.form.action='DistributoriVigilanza.do?command=TicketDetails&id=<%= OrgDetails.getId() %><%= addLinkParams(request, "popup|popupType|actionId") %>&idmacchinetta=<%=idMacchinetta %>'">
<br>
<dhv:formMessage />
