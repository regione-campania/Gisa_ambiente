...
[<%= fixValore(Modulo.getListaCampiModulo().get("progcode").get("progcode")).equals("2") ? "X" : ""%>] VIG001AL - Criteri microbiologici di sicurezza applicabili ai prodotti alimentari Reg. CE 2073/2005 - Altre analisi chimiche, microbiologiche e fisiche<br/>
[<%= fixValore(Modulo.getListaCampiModulo().get("progcode").get("progcode")).equals("3") ? "X" : ""%>] VIG001CP - Controllo ufficiale per i criteri di processo<br/>
[<%= fixValore(Modulo.getListaCampiModulo().get("progcode").get("progcode")).equals("4") ? "X" : ""%>] VIG00MON - Monitoraggi conoscitivi
</td>
...
[<%= fixValore(Modulo.getListaCampiModulo().get("aliquote_aggiuntive").get("aliquote_aggiuntive")).equals("4") ? "X" : ""%>] una delle aliquote contrassegnata dalla lettera/numero <label class="layout"><%= fixValore(Modulo.getListaCampiModulo().get("num_unita_aliquote_consegnate").get("num_unita_aliquote_consegnate"))%> </label> e' stata consegnata al/alla Sig./Sig.ra  <label class="layout"><%= fixValore(Modulo.getListaCampiModulo().get("nome_unita_aliquote_consegnate").get("nome_unita_aliquote_consegnate"))%> </label> 
[<%= fixValore(Modulo.getListaCampiModulo().get("aliquote_aggiuntive").get("aliquote_aggiuntive")).equals("5") ? "X" : ""%>] Trattandosi di aliquota unica (art. 7 co. 2 del D.Lgs. 27/2021), prelevata in Commercializzazione/Distribuzione, a causa di [<%= fixValore(Modulo.getListaCampiModulo().get("num_unita_aliquote_causa").get("num_unita_aliquote_causa")).equals("2") ? "X" : ""%>]  quantita' insufficiente alla composizione delle aliquote di legge  [<%= fixValore(Modulo.getListaCampiModulo().get("num_unita_aliquote_causa").get("num_unita_aliquote_causa")).equals("3") ? "X" : ""%>] data di scadenza prossima (10 gg) [<%= fixValore(Modulo.getListaCampiModulo().get("num_unita_aliquote_causa").get("num_unita_aliquote_causa")).equals("4") ? "X" : ""%>] alimento altamente deperibile (<10 gg), si richiede di eseguire un'analisi unica ed irripetibile garantendo i diritti alla difesa, da effettuare il <label class="layout"><%= fixValore(Modulo.getListaCampiModulo().get("data_unita_aliquote_unica").get("data_unita_aliquote_unica"))%> </label> alle ore <label class="layout"><%= fixValore(Modulo.getListaCampiModulo().get("ore_unita_aliquote_unica").get("ore_unita_aliquote_unica"))%> </label> <br/>
