...
//	alert('ddd');
	...
	if ($("#idControlloUfficiale").val()=='N.D')
		...
		if(id_asl >0 && (1==1 || id_asl == '204' || id_asl == '202')  && (id_operatore == '1' || id_operatore == '97' || id_operatore == '2' || id_operatore == '801' || id_operatore == '800'|| id_operatore == '999' || id_operatore == '2000')){
			//if(id_operatore == '1' || id_operatore == '97' || id_operatore == '2' || id_operatore == '801' || id_operatore == '800'|| id_operatore == '999'){
				
				
				PopolaCombo.verificaPNAA(<%=idCU2%> ,
						{
								callback:function(bool) 
								{ 
									if((bool && id_operatore == '999') || id_operatore!='999')
									{
										$.ajax({
									        type: "GET",
