  ...
  <tr class="containerBody">
    ...
    <td>
      <table border="0" cellspacing="0" cellpadding="0" class="empty">
        <tr>
          <td>
            <textarea name="esito_note_esame" id="esito_note_esame" cols="55" rows="8" onkeyup="this.value = this.value.replace(/[^a-zA-Z_0-9 ]/g,'');"><%=(TicketDetails.getEsitoNoteEsame()!=null) ? TicketDetails.getEsitoNoteEsame() : "" %></textarea>
          </td>
          <td valign="top">
