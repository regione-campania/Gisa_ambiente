...
<form name="main" action="MacellazioniNewSintesis.do?command=<%=update ? "Update" : "Save" %>ToLiberoConsumo&id=<%=Partita.getId()%>" method="post" onsubmit="return controllaForm( );">
