...
<%@page import="org.aspcfs.modules.dpatnew_templates.*" %>
...
<%
	...
	DpatIndicatoreNewBeanAbstract IndicatoreNewDPat = request.getAttribute("IndicatoreNewDPat") !=null ?  (DpatIndicatoreNewBeanAbstract)request.getAttribute("IndicatoreNewDPat") : null;
 ...
 function setListaPianiAttivitaFromSezione(idSezione,anno,congelato)
{
 ...
 <form name="addPiano" action="Dpat.do?command=ModificaIndicatoreEffettivo" method="post" onsubmit="return checkForm(this)">
<%-- Trails --%>
