...
<%@ include file="../initPage.jsp" %>
 ...
 function chiudiPopUp(flagInserimento)
 {
	  ...
	  {
		  window.opener.document.forms[0].action = 'Dpat.do?command=SearchPianiMonitoraggioNewDpat';
 ...
 <form name="addPiano" action="Dpat.do?command=InsertEffettivo" method="post" onsubmit="return checkForm(this.form,'<%=PianoAttivitaNewDPat != null ? "piano_attivita" : "indicatore"%>')">
