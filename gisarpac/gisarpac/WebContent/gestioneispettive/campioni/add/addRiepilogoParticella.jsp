...
function backForm(form){
	form.action="GestioneCampioni.do?command=AddVerbaleParticella";
	loadModalWindow();
	form.submit();
}
...
<form name="aggiungiCampione" action="GestioneCampioni.do?command=InsertParticella&auto-populate=true" onSubmit="" method="post">
