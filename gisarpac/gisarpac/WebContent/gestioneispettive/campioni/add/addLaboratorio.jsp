...
function backForm(form){
	form.action="GestioneCampioni.do?command=AddTipoAnalisi";
	loadModalWindow();
	form.submit();
}
...
<form name="aggiungiCampione" action="GestioneCampioni.do?command=AddGruppoIspettivo&auto-populate=true" onSubmit="" method="post">
...
<col width="20%">
<tr><th colspan="2"><center><b>LABORATORIO</b></center></th></tr>
