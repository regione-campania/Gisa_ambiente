...
function backForm(form){
	form.action="GestioneCampioni.do?command=AddGruppoIspettivo";
	loadModalWindow();
	form.submit();
}
...
<form name="aggiungiCampione" action="GestioneCampioni.do?command=Insert&auto-populate=true" onSubmit="" method="post">
...
<br/>
<center><font size="5px">Il campione sarà inserito come riportato nel riepilogo.</font></center>
<br/>
...
<input type="hidden" name="idGiornataIspettiva" id="idGiornataIspettiva" value="<%=jsonGiornataIspettiva.get("idGiornataIspettiva") %>">
 <% } %>
<input type="button" value="INDIETRO" onclick="backForm(this.form)" style="font-size:40px; background-color:red"/>
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
<input type="button" style="font-size:40px" value="INSERISCI CAMPIONE" onclick="checkForm(this.form)"/>
</td>
</tr>
</table>
<!-- BOTTONI -->
