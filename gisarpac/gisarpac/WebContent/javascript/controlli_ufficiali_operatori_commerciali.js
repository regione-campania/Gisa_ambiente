...
{
	if (confirm("Con questa azione tutte le checklist associate vengono chiuse ed una nuova categoria di rischio viene associata all'operatore commerciale. Sei sicuro di voler procedere?")) 
	{
