...
function aggiornaDatiStruttura(idStruttura,edit)
{
	...
	{
		PopolaCombo.aggiornaDatiStrutturaTemp(idStruttura,fattori,percentuale,{callback:aggiornaDatiStrutturaCallback,async:false});
	}
		}
	else
		{
...
{
	document.getElementById("carico_effettivo_struttura_"+beanStruttura.id).innerHTML = beanStruttura.caricoLavoroEffettivo;
}
