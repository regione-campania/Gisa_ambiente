...
<table class="trails" cellspacing="0" >
		<tr>	
			<td width="100%"><div align="left"><a href="Dpat.do">DPAT</a> &gt <a href="Dpat.do?command=Home&idAsl=<%=DpatSDC.getIdAsl()%>&anno=<%=DpatSDC.getAnno()%>">Allegati DPAT</a> &gt Modello 4 Strumento di Calcolo <%=DpatSDC.getAnno() %> ASL <%=ListaAsl.getSelectedValue(DpatSDC.getIdAsl()) %></div></td>
		</tr>
	</table>
