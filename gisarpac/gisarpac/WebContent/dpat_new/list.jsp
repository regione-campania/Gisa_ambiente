							...
							%>
							 <dhv:permission name="oia-modellazione_level1-view">
							  ...
							  <dhv:permission name="oia-modellazione_level1-edit">
								...
								<input class= "pulsante" type="button" value="dettaglio dpat" style="width:200px;" onClick="window.location='Dpat.do?command=DpatDetailGenerale&idAsl=<%=nodo_L1.getId_asl()%>&idPadre=<%=nodo_L1.getId()%>&anno=corrente'" />
							...
							<dhv:permission name="oia-modellazione_level3-view">
											<dhv:permission name="oia-modellazione_level3-edit">
															<input class= "pulsante" type="button" value="Modifica" style="width: 200px;" onClick="javascript:popLookupSelectorModificaNodoDpat('id=<%= nodo_L1.getId() %>');" />
																...
																<input class= "pulsante" type="button" value="Elimina" style="width: 200px;" onClick="javascript:confermaDelete('Dpat.do?command=Cancella&id=<%= nodo_L1.getId() %>')" />
																</dhv:permission>
															</dhv:permission>
							<%} %>
...
<%						
							...
							else
							{
											...
											<dhv:permission name="oia-modellazione_level3-edit">
																...
																<dhv:permission name="oia-modellazione_level3-delete">
																<input class= "pulsante" type="button" value="Elimina" style="width: 200px;" onClick="javascript:confermaDelete('Dpat.do?command=Cancella&id=<%= nodo_L2.getId() %>')" />
																</dhv:permission>
															</dhv:permission>
						...
						value="Modifica DPAT"  style="width: 200px" onClick="window.location='Dpat.do?command=AddDatiPerStruttura&idAsl=<%=nodo_L2.getId_asl()%>&idStrutt=<%=nodo_L2.getId()%>'" />
											<%}
...
<% 													ArrayList<DpatStruttura> nodi_livello_3_per_id_nodo_livello_2 =  nodo_L2.getLista_nodiDpat();
							...
							<td rowspan="1"><%=lookup_comuni.getSelectedValue(nodo_L3.getComune())+"<br>"+nodo_L3.getIndirizzo() +"<br>"+nodo_L3.getMail() %></td>
															...
															<dhv:permission name="oia-modellazione_level3-view">
																...
																<tr><td><input class= "pulsante" type="button" value="Elimina" style="width: 200px;" onClick="javascript:confermaDelete('Dpat.do?command=Cancella&id=<%= nodo_L3.getId() %>')" /></td></tr>
																<tr><td><input class="pulsante" type="button"  value="Modifica DPAT"  style="width: 200px" onClick="window.location='Dpat.do?command=AddDatiPerStruttura&idAsl=<%=nodo_L3.getId_asl()%>&idStrutt=<%=nodo_L3.getId()%>'" /></td></tr>
															</dhv:permission>
															</table>
															</td>
														</tr>																								
							 ...
							 <dhv:permission name="oia-modellazione_level1-view">
								...
								<%if (nodo_L1.getN_livello()==2){ %> 	
											...
											<dhv:permission name="oia-modellazione_level3-edit">
																...
																<dhv:permission name="oia-modellazione_level3-delete">
																<tr><td><input class= "pulsante" type="button" value="Elimina" style="width: 200px;" onClick="javascript:confermaDelete('Dpat.do?command=Cancella&id=<%= nodo_L1.getId() %>')" /></td></tr>
																</dhv:permission>
															</dhv:permission>
											<%}} %>
							 ...
							 <td onmouseover="inRow(this)" onmouseout="outRow(<%= nodo_L1.getId() %>,this)" >
								...
								<%if (nodo_L1.getN_livello()==2){ %> 	
											...
											<dhv:permission name="oia-modellazione_level3-edit">
															...
															<input class="pulsante" type="button"
						value="Modifica DPAT"  style="width: 200px" onClick="window.location='Dpat.do?command=AddDatiPerStruttura&idAsl=<%=nodo_L1.getId_asl()%>&idStrutt=<%=nodo_L1.getId()%>'" />
											<%}} %>
