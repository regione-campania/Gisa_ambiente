...
<td style="border:1px solid black;"><img style="text-decoration: none;" height="80" width="80" documentale_url="" src="gestione_documenti/schede/images/regioneaosta.jpg" /> </td>
...
Sono stati effettuati sul territorio della REGIONE VALLE D'AOSTA num. <label class="layout"><%=lista.getNumeroCuEseguiti() %></label> controlli ufficiali presso Operatori indicati nella lista di distribuzione con i seguenti esiti: <br/><br/>
