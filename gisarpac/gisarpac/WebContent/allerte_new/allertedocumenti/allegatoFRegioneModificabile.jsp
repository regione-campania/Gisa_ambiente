...
Sono stati effettuati sul territorio della REGIONE VALLE D'AOSTA num. <input type="text" value="<%=lista.getNumeroCuEseguiti() %>"/> controlli ufficiali presso Operatori indicati nella lista di distribuzione con i seguenti esiti: <br/><br/>
