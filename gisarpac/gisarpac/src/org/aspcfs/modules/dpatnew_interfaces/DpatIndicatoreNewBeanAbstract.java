...
public abstract class DpatIndicatoreNewBeanAbstract extends GenericBean{
	...
	public abstract Integer insertDummyChildPerPianoAttivitaScelto(Connection db, Integer anno, Long pianoAttivitaPadre) throws Exception;
	public abstract Integer insertDummyChildPerUltimoPianoAttivitaInserito(Connection db,Integer anno) throws Exception;
	public abstract void insert(Connection db) throws Exception;
	public abstract Integer insertBeforeOrAfter(Connection db, DpatIndicatoreNewBeanAbstract toInsert, DpatIndicatoreNewBeanAbstract indicatoreRiferimento, String where ) throws Exception;
	public abstract void insert(Connection db, DpatIndicatoreNewBeanAbstract indicatoreRiferimento, String descrizione,String codice_esame, String asl, String tipoAttivita, String alias, String codiceAlias) throws Exception ;
	public abstract void incrementaOrdiniPerPianoAttivita(Connection conn, String condition, Integer oidPianoAttivita, Integer anno  );
	public abstract void disabilitaByOid(Connection conn, int id,int anno ) throws Exception ;
	public abstract void disabilitaByOid(Connection conn, int id,int anno, Timestamp dataToSet ) throws Exception;
	public abstract Integer update(DpatIndicatoreNewBeanAbstract newValue, DpatIndicatoreNewBeanAbstract oldIndicatore, Connection db) throws Exception ;
	...
	public abstract int aggiornaCodiceAliasIndicatorePerTutteVersioni(Connection db, DpatIndicatoreNewBeanAbstract bean) throws Exception;
}
