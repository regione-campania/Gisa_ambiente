...
import org.aspcfs.modules.dpat.base.DpatStruttura;
...
public abstract class DpatAttribuzioneCompetenzeNewBeanAbstract extends GenericBean implements Cloneable{
	...
	public   void buildElencoStrutture(Connection db,int idAsl,SystemStatus system,int idArea){
		  ...
		  //ESEMPIO id_padre:id_figlio:id_figlio;id_padre:id_figlio:id_figlio
				...
				String sql =" select * from (select distinct on (a.codice_interno_fk) a.codice_interno_fk as cifk  ,a.* from ( select distinct o.data_scadenza, codice_interno_fk,carico_lavoro_effettivo, id as id_struttura ,id_padre, descrizione as descrizione , id_asl,o.livello ,o.pathid||';'||o.id as pathid,o.tipologia_struttura " +
