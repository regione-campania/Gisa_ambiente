...
public void setStato(int stato) {
	...
	public void congelaStrumentoCalcolo(Connection db) throws SQLException
	{
//		
	...
	public void inserDpatStrumentoCalcolo(Connection db,ActionContext context) throws SQLException
	{
		...
		String inserStrutture = "INSERT INTO strutture_asl( id_padre, id_asl, descrizione_lunga, n_livello, entered,entered_by, modified, modified_by, trashed_date, tipologia_struttura,"+ 
            ...
            " carico_lavoro_annuo, percentuale_da_sottrarre, carico_lavoro_effettivo, "+
            " fattori_incidenti_su_carico, codice_interno_fk, nome, id_utente,mail, indirizzo, delegato, descrizione_comune, id_oia_nodo_temp,"+ 
       ...
       " null, null, null,null, codice_interno_fk, null ,null,null, null, null, null, null,"+ 
...
//		String inserStrutture = "INSERT INTO strutture_asl(id_strumento_calcolo, id_struttura, carico_lavoro_annuo, fattori_incidenti_su_carico,percentuale_da_sottrarre, carico_lavoro_effettivo) (select ?,id,0,'',0,0 from dpat_struttura where id_asl = ? and n_livello >1)";
	...
	public void inserDpatStrumentoCalcoloConfig(Connection db,ActionContext context) throws SQLException
	{
		...
		sql = "insert into dpat_strumento_calcolo_strutture_temp(id_strumento_calcolo,id_struttura,carico_lavoro_annuo,fattori_incidenti_su_carico,percentuale_da_sottrarre,carico_lavoro_effettivo,trashed_date,id_dpat_sc_strutture) "+
		"(" +
		"select ?,n.id,carico_lavoro_annuo,fattori_incidenti_su_carico,percentuale_da_sottrarre,carico_lavoro_effettivo,scs.trashed_date,scs.id "+
		...
		sql = "insert into dpat_strumento_calcolo_nominativi_temp (id_anagrafica_nominativo,id_lookup_qualifica,carico_lavoro_annuale,fattori_incidenti_su_carico,id_dpat_strumento_calcolo_strutture,percentuale_ui_da_sottrarre,trashed_date) "+
		"( "+
		"select id_anagrafica_nominativo,id_lookup_qualifica,carico_lavoro_annuale,scn.fattori_incidenti_su_carico,scstemp.id,percentuale_ui_da_sottrarre,scn.trashed_date "+
...
//		String inserStrutture = "INSERT INTO dpat_strumento_calcolo_strutture(id_strumento_calcolo, id_struttura, carico_lavoro_annuo, fattori_incidenti_su_carico,percentuale_da_sottrarre, carico_lavoro_effettivo) (select ?,id,0,'',0,0 from dpat_struttura where id_asl = ? and n_livello >1)";
//		pst = db.prepareStatement(inserStrutture);
//		pst.setInt(1, this.id);
